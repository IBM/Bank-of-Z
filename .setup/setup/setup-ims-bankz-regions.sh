...
//OUT  DD DSN=${APP_IMS_HLQ}.PROCLIB(DFSJMP),DISP=SHR
//SYSTSPRT DD SYSOUT=*
//SYSTSIN DD *
...
cp "/tmp/IMS-bankz-reg-simlink-$$.txt" "//'${APP_IMS_HLQ}.IMSJAVA.JOBS(SIMLINK)'"


MEMBER_EXISTS=False
set +e
if head "//'${APP_IMS_HLQ}.IMSJAVA.JOBS(${DFS_IMS_SSID}JMP1)'" > /dev/null 2>&1; then
MEMBER_EXISTS=True
fi
set -e
python "$SCRIPTS_DIR/../lib/render_template.py" --configFile $CONFIG_FILE \
...
cp "//'${APP_IMS_HLQ}.IMSJAVA.JOBS(IMS2JMP1)'" "//'${APP_IMS_HLQ}.IMSJAVA.JOBS(STARTJMP)'"
...
cp "//'${APP_IMS_HLQ}.PROCLIB(DFSJVMEV)'" "//'${APP_IMS_HLQ}.IMSJAVA.JOBS(DFSJVMEV)'"
...
#cp "//'${APP_IMS_HLQ}.PROCLIB(DFSJVMMS)'" "//'${APP_IMS_HLQ}.IMSJAVA.JOBS(DFSJVMMS)'"
...
cp "//'${APP_IMS_HLQ}.PROCLIB(DFSJVMAP)'" "//'${APP_IMS_HLQ}.IMSJAVA.JOBS(DFSJVMAP)'"
...
cp "/tmp/IMS-bankz-reg-stopjmp-$$.txt" "//'${APP_IMS_HLQ}.IMSJAVA.JOBS(STOPJMP)'"
...
//OUT  DD DSN=${APP_IMS_HLQ}.PROCLIB(DFSMPR1),DISP=SHR
//SYSTSPRT DD SYSOUT=*
//SYSTSIN DD *
 OCOPY INDD(IN) OUTDD(OUT) TEXT
/*
...
//OUT  DD DSN=${APP_IMS_HLQ}.PROCLIB(DFSMPR2),DISP=SHR
//SYSTSPRT DD SYSOUT=*
//SYSTSIN DD *
 OCOPY INDD(IN) OUTDD(OUT) TEXT
/*
...
//OUT  DD DSN=${APP_IMS_HLQ}.JOBS(STOPMPP1),DISP=SHR
//SYSTSPRT DD SYSOUT=*
//SYSTSIN DD *
 OCOPY INDD(IN) OUTDD(OUT) TEXT
/*
...
//OUT  DD DSN=${APP_IMS_HLQ}.JOBS(STOPMPP2),DISP=SHR
//SYSTSPRT DD SYSOUT=*
//SYSTSIN DD *
 OCOPY INDD(IN) OUTDD(OUT) TEXT
/*
...
//OUT  DD DSN=${APP_IMS_HLQ}.PROCLIB(DFSINTDC),DISP=SHR
//SYSTSPRT DD SYSOUT=*
//SYSTSIN DD *
 OCOPY INDD(IN) OUTDD(OUT) TEXT
/*
...
# =========================
jsub "${APP_IMS_HLQ}.JOBS(IMS2MPP2)"  2>/dev/null
sleep 5
jsub "${APP_IMS_HLQ}.JOBS(IMS2MPP1)"  2>/dev/null
sleep 5
jsub "${APP_IMS_HLQ}.IMSJAVA.JOBS(STARTJMP)"  2>/dev/null
sleep 5
