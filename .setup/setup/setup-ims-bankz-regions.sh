...
cp "//'${IMS_APP_HLQ}.IMSJAVA.JOBS(IMS2JMP1)'" "//'${IMS_APP_HLQ}.IMSJAVA.JOBS(STARTJMP)'"
...
# =========================
jsub "${IMS_APP_HLQ}.JOBS(IMS2MPP2)"  2>/dev/null
sleep 5
jsub "${IMS_APP_HLQ}.JOBS(IMS2MPP1)"  2>/dev/null
sleep 5
