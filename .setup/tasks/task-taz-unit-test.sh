...
export TAZ_TEST_PATH=${TAZ_TEST_PATH:-$(get_section_value 'taz' 'test_dir')}
...
TAZ_RESULTS_DIR="$SANDBOX_DIR/logs/taz/.taz-edt-results"
TAZ_LOG_DIR="$SANDBOX_DIR/logs/taz/.taz-edt/logs"
TAZ_LOG_TAR="$SANDBOX_DIR/logs/taz/taz-unittest-log.tar"
