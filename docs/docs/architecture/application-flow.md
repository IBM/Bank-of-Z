...
![Request Flow Diagram](https://pages.github.com/Bank-of-Z/docs/docs/architecture/images/request-flow-diagram.jpg)
...
![External Integration](https://pages.github.com/Bank-of-Z/docs/docs/architecture/images/external-integration.jpg)
