...
Before using this workflow, complete the [Installation and Setup](https://pages.github.com/Bank-of-Z/docs/docs/installation-and-setup/) procedures and verify connectivity to the target z/OS environment.
...
[Installation and Setup](https://pages.github.com/Bank-of-Z/docs/docs/installation-and-setup/)

[GRUB Workflow](https://pages.github.com/Bank-of-Z/docs/docs/development-workflows/grub-workflow.html)

[Configuration Reference](https://pages.github.com/Bank-of-Z/docs/docs/reference/configuration-reference.html)

[Troubleshooting Guide](https://pages.github.com/Bank-of-Z/docs/docs/troubleshooting/)