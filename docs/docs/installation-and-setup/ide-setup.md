...
For supported platform requirements and minimum software versions, see [Prerequisites](https://pages.github.com/Bank-of-Z/docs/docs/installation-and-setup/prerequisites.html).
...
For prerequisite software versions and installation requirements, see [Prerequisites](https://pages.github.com/Bank-of-Z/docs/docs/installation-and-setup/prerequisites.html).
...
Review the required extension list in [Prerequisites](https://pages.github.com/Bank-of-Z/docs/docs/installation-and-setup/prerequisites.html) before installing them using one of the methods described below.
...
**Note:** If issues occur during installation or configuration, see the [Troubleshooting](https://pages.github.com/Bank-of-Z-doc/docs/docs/troubleshooting/).

## Next Step

After configuring your development environment, continue to [Build and Deploy](https://pages.github.com/Bank-of-Z/docs/docs/installation-and-setup/build-and-deploy.html) to build and deploy the Bank of Z application.