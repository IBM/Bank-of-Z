...
For detailed workflow instructions, see [VS Code Workflow](https://pages.github.com/Bank-of-Z/docs/docs/development-workflows/vscode-workflow.html).

## GRUB Workflow Commands

The GRUB workflow synchronizes local changes to USS and runs the Bank of Z setup process.

See to [GRUB Workflow](https://pages.github.com/Bank-of-Z/docs/docs/development-workflows/grub-workflow.html) for environment-specific configuration and run procedures.