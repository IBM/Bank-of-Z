      ...
      *
           ...
           STRING COMM-FIRST-NAME DELIMITED BY '  '
                  ' ' DELIMITED BY SIZE
                  COMM-LAST-NAME DELIMITED BY '  '
              INTO WS-FULL-NAME
           END-STRING
      ...
      *
           ...
           MOVE COMM-TITLE TO CUSTOMER-TITLE.
           MOVE COMM-FIRST-NAME TO CUSTOMER-FIRST-NAME.
           MOVE COMM-LAST-NAME TO CUSTOMER-LAST-NAME.
           MOVE COMM-DATE-OF-BIRTH TO CUSTOMER-DATE-OF-BIRTH.
           MOVE COMM-EMAIL TO CUSTOMER-EMAIL.
           MOVE COMM-PHONE TO CUSTOMER-PHONE.
           MOVE COMM-ADDR-LINE1 TO CUSTOMER-ADDR-LINE1.
           MOVE COMM-ADDR-LINE2 TO CUSTOMER-ADDR-LINE2.
           MOVE COMM-CITY TO CUSTOMER-CITY.
           MOVE COMM-POSTCODE TO CUSTOMER-POSTCODE.
           MOVE COMM-COUNTRY TO CUSTOMER-COUNTRY.
      ...
      *
           ...
           MOVE COMM-TITLE TO HV-CUSTOMER-TITLE.
           MOVE COMM-FIRST-NAME TO HV-CUSTOMER-FIRST-NAME.
           MOVE COMM-LAST-NAME TO HV-CUSTOMER-LAST-NAME.
           MOVE COMM-DATE-OF-BIRTH TO HV-CUSTOMER-DOB.
           MOVE COMM-EMAIL TO HV-CUSTOMER-EMAIL.
           MOVE COMM-PHONE TO HV-CUSTOMER-PHONE.
           MOVE COMM-ADDR-LINE1 TO HV-CUSTOMER-ADDR-LINE1.
           MOVE COMM-ADDR-LINE2 TO HV-CUSTOMER-ADDR-LINE2.
           MOVE COMM-CITY TO HV-CUSTOMER-CITY.
           MOVE COMM-POSTCODE TO HV-CUSTOMER-POSTCODE.
           MOVE COMM-COUNTRY TO HV-CUSTOMER-COUNTRY.
           MOVE COMM-STATUS TO HV-CUSTOMER-STATUS.
           MOVE COMM-CREATED-DATE TO HV-CUSTOMER-CREATE-DATE.
      ...
      *
           ...
           STRING CUSTOMER-FIRST-NAME DELIMITED BY '  '
                  ' ' DELIMITED BY SIZE
                  CUSTOMER-LAST-NAME DELIMITED BY '  '
              INTO STORED-NAME
           END-STRING.
