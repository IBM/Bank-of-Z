      ...
      *
       ...
       01 WS-POINTER-BYTES REDEFINES WS-POINTER
                                        PIC X(8).
       01 WS-POINTER-NUMBER REDEFINES WS-POINTER
                                        PIC 9(8) BINARY.
      ...
      *
           IF INQCUST-INQ-SUCCESS = 'Y'
              ...
              MOVE CUSTOMER-PHONE OF OUTPUT-DATA
                 TO INQCUST-PHONE
              MOVE CUSTOMER-ADDR-LINE1 OF OUTPUT-DATA
                 TO INQCUST-ADDR-LINE1
              MOVE CUSTOMER-ADDR-LINE2 OF OUTPUT-DATA
                 TO INQCUST-ADDR-LINE2
              MOVE CUSTOMER-CITY OF OUTPUT-DATA
                 TO INQCUST-CITY
              MOVE CUSTOMER-POSTCODE OF OUTPUT-DATA
                 TO INQCUST-POSTCODE
              MOVE CUSTOMER-COUNTRY OF OUTPUT-DATA
                 TO INQCUST-COUNTRY
      ...
      *
           IF SQLCODE = 0
              ...
              MOVE HV-CUSTOMER-CREATE-DATE TO CUSTOMER-CREATED-DATE
      ...
      *
                   ...
                   DISPLAY
                      'INQCUST: Unable to perform Synpoint Rollback.'
